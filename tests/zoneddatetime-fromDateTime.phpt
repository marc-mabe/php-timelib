...
--EXPECT--
ZonedDateTime::fromDateTime(ZoneOffset('UTC'), LocalDate('Sat 2000-01-01'), LocalTime('01:02:03.000123456'))
ZonedDateTime('Sat 2000-01-01 01:02:03.000123456 +00:00 [UTC]')
ZonedDateTime::fromDateTime(ZoneOffset('UTC'), LocalDateTime('Sat 2000-01-01 01:02:03.000123456'), LocalDateTime('Sat 2000-01-01 01:02:03.000123456'))
ZonedDateTime('Sat 2000-01-01 01:02:03.000123456 +00:00 [UTC]')
ZonedDateTime::fromDateTime(ZoneOffset('UTC'), LocalDateTime('Sat 2000-01-01 01:02:03.000123456'))
