...
echo stringify($zero) . ' diff ' . stringify($duration1) . ' = ' . stringify($zero->diff($duration1)) . "\n";
echo stringify($duration1) . ' diff ' . stringify($duration2) . ' = ' . stringify($duration1->diff($duration2)) . "\n";
echo stringify($duration2) . ' diff ' . stringify($duration1) . ' = ' . stringify($duration2->diff($duration1)) . "\n";
echo stringify($duration1->inverted()) . ' diff ' . stringify($duration2) . ' = ' . stringify($duration1->inverted()->diff($duration2)) . "\n";
echo stringify($duration2->inverted()) . ' diff ' . stringify($duration1) . ' = ' . stringify($duration2->inverted()->diff($duration1)) . "\n";
