...
-----
LocalDate('Sat 2005-01-01')	W1	2005	WeekInfo(Sunday, 1)
LocalDate('Sun 2005-01-02')	W2	2005	WeekInfo(Sunday, 1)
LocalDate('Sat 2005-12-31')	W53	2005	WeekInfo(Sunday, 1)
LocalDate('Sun 2006-01-01')	W1	2006	WeekInfo(Sunday, 1)
LocalDate('Mon 2006-01-02')	W1	2006	WeekInfo(Sunday, 1)
LocalDate('Mon 2006-12-25')	W52	2006	WeekInfo(Sunday, 1)
LocalDate('Tue 2006-12-26')	W52	2006	WeekInfo(Sunday, 1)
LocalDate('Wed 2006-12-27')	W52	2006	WeekInfo(Sunday, 1)
LocalDate('Thu 2006-12-28')	W52	2006	WeekInfo(Sunday, 1)
LocalDate('Fri 2006-12-29')	W52	2006	WeekInfo(Sunday, 1)
LocalDate('Sat 2006-12-30')	W52	2006	WeekInfo(Sunday, 1)
LocalDate('Sun 2006-12-31')	W1	2007	WeekInfo(Sunday, 1)
LocalDate('Mon 2007-01-01')	W1	2007	WeekInfo(Sunday, 1)
LocalDate('Tue 2007-01-02')	W1	2007	WeekInfo(Sunday, 1)
LocalDate('Wed 2007-01-03')	W1	2007	WeekInfo(Sunday, 1)
LocalDate('Thu 2007-01-04')	W1	2007	WeekInfo(Sunday, 1)
LocalDate('Fri 2007-01-05')	W1	2007	WeekInfo(Sunday, 1)
LocalDate('Sat 2007-01-06')	W1	2007	WeekInfo(Sunday, 1)
LocalDate('Sun 2007-01-07')	W2	2007	WeekInfo(Sunday, 1)
LocalDate('Mon 2007-01-08')	W2	2007	WeekInfo(Sunday, 1)
LocalDate('Sun 2007-12-30')	W1	2008	WeekInfo(Sunday, 1)
LocalDate('Mon 2007-12-31')	W1	2008	WeekInfo(Sunday, 1)
LocalDate('Tue 2008-01-01')	W1	2008	WeekInfo(Sunday, 1)
LocalDate('Wed 2008-01-02')	W1	2008	WeekInfo(Sunday, 1)
LocalDate('Sun 2008-12-28')	W1	2009	WeekInfo(Sunday, 1)
LocalDate('Mon 2008-12-29')	W1	2009	WeekInfo(Sunday, 1)
LocalDate('Tue 2008-12-30')	W1	2009	WeekInfo(Sunday, 1)
LocalDate('Wed 2008-12-31')	W1	2009	WeekInfo(Sunday, 1)
LocalDate('Thu 2009-01-01')	W1	2009	WeekInfo(Sunday, 1)
LocalDate('Thu 2009-12-31')	W1	2010	WeekInfo(Sunday, 1)
LocalDate('Fri 2010-01-01')	W1	2010	WeekInfo(Sunday, 1)
LocalDate('Sat 2010-01-02')	W1	2010	WeekInfo(Sunday, 1)
LocalDate('Sun 2010-01-03')	W2	2010	WeekInfo(Sunday, 1)
LocalDate('Mon 2010-01-04')	W2	2010	WeekInfo(Sunday, 1)
-----
