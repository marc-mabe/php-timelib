...
$dateMin    = $min->date;
$dateEpoch  = \time\PlainDate::fromYmd(1970, 1, 1);
$dateUsual  = \time\PlainDate::fromYmd(2025, 2, 3);
$timeZero   = \time\PlainTime::fromHms(0, 0, 0);
$timeMax    = \time\PlainTime::fromHms(23, 59, 59, 999999999);
$dtMin      = \time\PlainDateTime::fromDateTime($min->date, $min->time);
$dtEpoch    = \time\PlainDateTime::fromDateTime($dateEpoch, $timeZero);
$dtUsual    = \time\PlainDateTime::fromDateTime($dateUsual, $timeMax);
...
echo "  fromDateTime(" . stringifyPlainDate($dateEpoch) . ")\n";
...
Instant::fromDateTime
  fromDateTime(PlainDate('Mon 2025-02-03'))
    Instant('Mon 2025-02-03 00:00:00', 1738540800, 0)
  fromDateTime(PlainDate('Thu 1970-01-01'))
    Instant('Thu 1970-01-01 00:00:00', 0, 0)
  fromDateTime(PlainDate('Mon 2025-02-03'))
    Instant('Mon 2025-02-03 00:00:00', 1738540800, 0)
  fromDateTime(PlainDate('Mon 2025-02-03'), PlainTime('00:00:00'))
    Instant('Mon 2025-02-03 00:00:00', 1738540800, 0)
  fromDateTime(PlainDate('Thu 1970-01-01'), PlainTime('00:00:00'))
    Instant('Thu 1970-01-01 00:00:00', 0, 0)
  fromDateTime(PlainDate('%s'), PlainTime('23:59:59.999999999'))
    Instant('%s 23:59:59.999999999', -%d, 999999999)
  fromDateTime(PlainDateTime('Mon 2025-02-03 23:59:59.999999999'))
    Instant('Mon 2025-02-03 00:00:00', 1738540800, 0)
  fromDateTime(PlainDateTime('Mon 2025-02-03 23:59:59.999999999'), PlainDateTime('Mon 2025-02-03 23:59:59.999999999'))
    Instant('Mon 2025-02-03 23:59:59.999999999', 1738627199, 999999999)
  fromDateTime(PlainDateTime('Thu 1970-01-01 00:00:00'), PlainDateTime('Thu 1970-01-01 00:00:00'))
    Instant('Thu 1970-01-01 00:00:00', 0, 0)
  fromDateTime(PlainDateTime('%s'), PlainDateTime('%s'))
    Instant('%s', -%d, 0)
  fromDateTime(PlainDateTime('Mon 2025-02-03 23:59:59.999999999'), PlainDateTime('%s'))
    Instant('Mon 2025-02-03 %s', %d, 0)
  fromDateTime(PlainDateTime('%s'), PlainDateTime('Mon 2025-02-03 23:59:59.999999999'))
    Instant('%s 23:59:59.999999999', -%d, 999999999)
  fromDateTime(PlainDate('Mon 2025-02-03'), PlainTime('23:59:59.999999999'), time\Zone('Europe/Berlin'))
    Instant('Mon 2025-02-03 22:59:59.999999999', 1738623599, 999999999)
  fromDateTime(PlainDate('Mon 2025-02-03'), PlainTime('23:59:59.999999999'), time\Zone('UTC'))
    Instant('Mon 2025-02-03 23:59:59.999999999', 1738627199, 999999999)
  fromDateTime(PlainDate('%s'), PlainTime('23:59:59.999999999'), time\ZoneOffset('+00:00'))
    Instant('%s 23:59:59.999999999', -%d, 999999999)
Instant::fromYmd
